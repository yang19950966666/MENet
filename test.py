...
parser.add_argument('--testsize', type=int, default=520, help='testing size') #416
parser.add_argument('--pth_path', type=str, default='./checkpoints/menet/MENet_modified.pth')

for _data_name in ['CAMO','CHAMELEON','COD10K','NC4K']:
    data_path = './data/TestDataset/{}/'.format(_data_name)
    save_path = './results/MENet/{}/'.format(_data_name)
